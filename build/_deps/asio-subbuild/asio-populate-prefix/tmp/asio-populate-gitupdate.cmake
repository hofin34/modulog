...
execute_process(
  COMMAND "/usr/bin/git" show-ref "asio-1-20-0"
  WORKING_DIRECTORY "/home/martin/School/bachelor-hofbauer/build/_deps/asio-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("asio-1-20-0" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/asio-1-20-0")
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/home/martin/School/bachelor-hofbauer/build/_deps/asio-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/home/martin/School/bachelor-hofbauer/build/_deps/asio-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
