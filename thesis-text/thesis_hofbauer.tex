...
%   thesis_hofbauer-20-literatura-bibliography.bib - literatura / bibliography
%   thesis_hofbauer-01-kapitoly-chapters.tex - obsah práce / the thesis content
%   thesis_hofbauer-01-kapitoly-chapters-en.tex - obsah práce v angličtině / the thesis content in English
%   thesis_hofbauer-30-prilohy-appendices.tex - přílohy / appendices
%   thesis_hofbauer-30-prilohy-appendices-en.tex - přílohy v angličtině / appendices in English
%==============================================================================
...
\begin{document}
  ...
  % ----------------------------------------------
  \ifenglish
    \input{thesis_hofbauer-01-kapitoly-chapters-en}
  \else
    \input{thesis_hofbauer-01-kapitoly-chapters}
  \fi
...
\fi
  \begin{flushleft}
  \bibliography{thesis_hofbauer-20-literatura-bibliography}
  \end{flushleft}
...
\fi
  ...
  % Přílohy / Appendices
  \ifenglish
    \input{thesis_hofbauer-30-prilohy-appendices-en}
  \else
    \input{thesis_hofbauer-30-prilohy-appendices}
  \fi
  
  % Kompilace po částech (viz výše, nutno odkomentovat)
  % Compilation piecewise (see above, it is necessary to uncomment it)
  %\subfile{thesis_hofbauer-30-prilohy-appendices}
