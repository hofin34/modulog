...
namespace modulog::watchdog_agent {
    ...
    public:
        WatchdogHandler(std::shared_ptr<asio::io_context> &ioContext, int checkoutInterval, std::shared_ptr<AgentClient> agentClient) : checkoutInterval_(checkoutInterval),
